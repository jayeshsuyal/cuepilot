...
- Integrated CuePilot source including the frontend: completed with 0 reported findings at 21:03 UTC.
...
- Node and optional sponsor-setup dependencies: the final full scan at 20:48 UTC
  and the repeated final scan at 21:03 UTC report the six advisories below. The overall exit is 1 because findings
...
CuePilot's Cloud adapter now uses HTTP calls and its minimal runtime manifest was
...
`sponsor-setup/snyk/reports/20260911T210305.104186Z/`; frontend dependency evidence
is in `cuepilot/web/verification/security-reports/2026-09-11T20-59-12.915Z/`. The application Python
